        ...
        if game_status == 'game':
            ...
            if game_status != 'game':
                ...
                if game_status == 'win':
                    ...
                    surface.blit(text, (WINDOW_SIZE/2 - text.get_width()/2, WINDOW_SIZE/2 - text.get_height()/2 - 30))
                ...
                surface.blit(text, (WINDOW_SIZE/2 - text.get_width()/2, WINDOW_SIZE/2 - text.get_height()/2 + 55))
